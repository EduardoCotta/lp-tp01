...
{fin = [(N 41)], trans = 0},
{fin = [(N 4),(N 66)], trans = 19},
{fin = [(N 4)], trans = 19},
{fin = [(N 49),(N 66)], trans = 0},
{fin = [(N 45),(N 66)], trans = 22},
{fin = [(N 25)], trans = 0},
{fin = [(N 16),(N 66)], trans = 0},
{fin = [(N 43),(N 66)], trans = 0},
{fin = [(N 47),(N 66)], trans = 0},
{fin = [(N 14),(N 66)], trans = 0},
{fin = [(N 12),(N 66)], trans = 0},
{fin = [(N 66)], trans = 29},
{fin = [(N 28)], trans = 0},
{fin = [(N 55),(N 66)], trans = 31},
{fin = [(N 33)], trans = 0},
{fin = [(N 7),(N 66)], trans = 33},
{fin = [(N 7)], trans = 33},
{fin = [(N 1)], trans = 0}])
end
...
| 10 => let val yytext=yymktext() in getKeywordOrName(yytext,yypos,yypos) end
| 12 => (LPAR(yypos,yypos))
| 14 => (RPAR(yypos,yypos))
| 16 => (COMMA(yypos,yypos))
| 18 => (LSBRACK(yypos,yypos))
| 20 => (RSBRACK(yypos,yypos))
| 22 => (SEMICOLON(yypos, yypos))
| 25 => (ARROW(yypos, yypos))
| 28 => (AND(yypos, yypos))
| 30 => (EQ(yypos, yypos))
| 33 => (NOTEQ(yypos, yypos))
| 35 => (LT(yypos, yypos))
| 38 => (LTE(yypos, yypos))
| 4 => let val yytext=yymktext() in NUM(valOf(Int.fromString yytext), !lineNumber, !lineNumber) end
| 41 => (DOUBLECOLON(yypos, yypos))
| 43 => (PLUS(yypos, yypos))
| 45 => (MINUS(yypos, yypos))
| 47 => (TIMES(yypos, yypos))
| 49 => (DIV(yypos, yypos))
| 51 => (PIPE(yypos, yypos))
| 53 => (UNDERSCORE(yypos, yypos))
| 55 => (NEGATION(yypos, yypos))
| 57 => (LKEY(yypos, yypos))
| 59 => (RKEY(yypos, yypos))
